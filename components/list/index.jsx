...
const filters = [
  {
    ...
    options: [
      ...
      { value: 'roses', label: 'Roses', checked: false },
      { value: 'birthday-bouquet', label: 'Birthday Bouquet', checked: true },
      { value: 'mother-day', label: 'Mother day', checked: false },
      { value: 'for-valentine', label: 'For valentine', checked: false },
    ],
  },
  {
    id: 'color',
